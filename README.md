...
- Full user interaction through  buttons and input   
- Data updates instantly (no refresh is needed!)
...
## Quality Attributes
The app also reflects the following **quality attributes**:

- **Usability:** Simple interface with clear labels and buttons.  
- **Performance:** Updates (add/remove) appear instantly with no lag.  
- **Accessibility:** Keyboard navigation and readable color contrast.
...
## Release Notes
- Initial release for **CS361 Milestone #1**  
- Implements three user stories: Add Show, Remove Show, and Mark Episode Watched  
- Demonstrates Inclusivity Heuristics and Quality Attributes  
- Fully working main program providing clear user value  
